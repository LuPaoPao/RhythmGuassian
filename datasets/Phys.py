...
#
TARGET_DOMAIN = {
    'VIPL': ['V4V', 'PURE', 'BUAA', 'UBFC', 'Phys'], # , 'MR-NIRP' ,'VV100', 'UCLA-rPPG', 'Phys', "MMPD"
    'V4V': ['VIPL', 'PURE', 'BUAA', 'UBFC', 'Phys']
}
...
def main():
    ...
    log = Logger()
    log_path = os.path.join('./Result_log', f"Phys{rPPGNet_name}_{para_name}log.txt")
