...
def get_args():
    ...
    parser.add_argument('-k1', '--k1', type=float, default=0.1,
                        help='k1', dest='k1')
    parser.add_argument('-k2', '--k2', type=float, default=0.0,
                        help='k2', dest='k2')
    parser.add_argument('-k3', '--k3', type=float, default=0.01,
                        help='k3', dest='k3')
    parser.add_argument('-k4', '--k4', type=float, default=0.0,
                        help='k4', dest='k4')
    parser.add_argument('-k5', '--k5', type=float, default=0.0,
                        help='k5', dest='k5')
    parser.add_argument('-k6', '--k6', type=float, default=0.00001,
                        help='k6', dest='k6')
    parser.add_argument('-k7', '--k7', type=float, default=0.0001,
                        help='k7', dest='k7')
    parser.add_argument('-k8', '--k8', type=float, default=0.0,
                        help='k8', dest='k8')
    parser.add_argument('-k9', '--k9', type=float, default=0.0001,
                        help='k9', dest='k9')
    parser.add_argument('-k10', '--k10', type=float, default=0.0,
                        help='k10', dest='k10')
    ...
    parser.add_argument('--lambda_rec', type=float, default=0.1,
                        help='L_rec weight', dest='lambda_rec')
    parser.add_argument('--lambda_st', type=float, default=1.0,
                        help='L_st weight (spatio-temporal consistency on v_d)',
                        dest='lambda_st')
    parser.add_argument('--lambda_m', type=float, default=1.0,
                        help='L_m weight (motion-flow vs v_n modulus consistency)',
                        dest='lambda_m')
